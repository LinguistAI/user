...
public class AccountServiceTest {
    ...
    void whenResetTokenExpiredThenDoNotValidate() {
        try {
            ...
            assertThrows(InvalidResetCodeException.class, () -> accountService.validateResetCode(email, resetToken.getResetCode(), false));
        } catch (Exception e) {
            fail("TEST FAILED: " + e.getMessage());
        }
    }
    ...
    void whenInvalidateResetTokenTrueThenInvalidateToken() {
        try {
            ...
            accountService.validateResetCode(email, resetToken.getResetCode(), true);
